...
fpga = casperfpga.CasperFpga('10.17.90.187')     # Use your RFSoC IP address
print('Done')

fpga.upload_to_ram_and_program('/home/jose/Workspace/RFSoC-MINI-2SB-Receiver/32_bits_models/8192ch_32bits_reset/dss_ideal_first_quant_8192ch_32bits_reset_1966mhz_cx.fpg')

print('Configuring accumulation period...')
fpga.write_int('acc_len', 2**13)
# fpga.write_int('acc_len_re_bin', 2**12)
time.sleep(1)
print('Done')
